  ...
  const handleEmergencySubmit = async () => {
    ...
    return (
      ...
      >
        ...
        {/* Top Bar */}
        <div className="flex justify-between items-center p-4 fixed top-0 left-0 right-0 max-w-md mx-auto z-50">
        ...
        {/* Main Title */}
        <div className="text-center pt-8 px-4 flex flex-col items-center chromatic-aberration">
