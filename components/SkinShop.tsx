...
export const SkinShop: React.FC<SkinShopProps> = ({
  ...
  return (
    <div className={`fixed inset-0 bg-black/90 backdrop-blur-md z-[600] flex flex-col ${isClosing ? 'tv-screen-off' : 'tv-screen-on'}`} style={{ paddingTop: 'max(env(safe-area-inset-top), 28px)' }}>
      {/* Header */}
